...
export class HomePage {
  constructor(public navCtrl: NavController, private zbar: ZBar, private barcodeScanner: BarcodeScanner, private transfer: FileTransfer, private file: File, private alertCtrl: AlertController) {
  }
  TestPage() {
